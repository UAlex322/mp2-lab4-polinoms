...
private:
	...
	void merge_general(Node *&first, Node *second); // обобщЄнна€ процедура сли€ни€ (принимает узлы списков, результат сли€ни€ лежит по первому указателю)
	void mergesort(Node *&first); // внутренн€€ функци€ сортировки сли€нием

	Node *head = new Node(); // голова списка
	size_t _size; // текущее количество узлов в списке без учЄта головы
...
public:
	...
	void reverse();
	void merge(List other); // сли€ние списков
	void sort();
...
List<Type>& List<Type>::operator=(const List &copy) {
	...
	// ≈сли закончилс€ исходный список, а у нового больший размер
	...
	// Ќовый список кончилс€, а исходного больший размер
...
// ќбобщЄнна€ процедура сли€ни€ (принимает узлы списков, результат сли€ни€ лежит по первому указателю)
template<typename Type>
...
// —ли€ние двух отсортированных списков
template<typename Type>
